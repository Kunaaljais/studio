...
export function SeoContent() {
  return (
    <section className="w-full max-w-lg md:max-w-xl text-left text-sm text-muted-foreground mt-8">
      <h2 className="text-xl font-bold text-primary-foreground mb-4">Connect and Chat Anonymously</h2>
      <p className="mb-4">
      ...
      <h3 className="text-lg font-semibold text-primary-foreground mb-2">Community Guidelines</h3>
      <p className="mb-4">
      ...
      <h3 className="text-lg font-semibold text-primary-foreground mb-2">About Us</h3>
      <p>
