...
export function VoiceChat() {
  ...
  const renderControls = () => {
    ...
    if (showNextCallUI && callState === 'idle' && !confirmHangup && !autoCall) {
         const regularIdleUI = renderIdleControls();
         return (
    ...
    if (confirmHangup && callState === 'idle' && showNextCallUI) {
        return (
        ...
        <div className="flex flex-col items-center justify-center text-center gap-2 w-full">
            ...
            <div className="flex justify-center items-start gap-1">
                <Button variant="ghost" className="flex flex-col items-center justify-center h-auto px-3 py-2 hover:bg-transparent" onClick={findRandomCall}>
                    <div className="bg-green-500 hover:bg-green-600 rounded-full p-3 transition-colors">
                    <Phone className="w-6 h-6 text-white"/>
                    </div>
                    <span className="mt-1 text-xs">Call</span>
                </Button>

                <Button variant="ghost" className="flex flex-col items-center justify-center h-auto px-3 py-2 disabled:opacity-50 hover:bg-transparent" onClick={toggleMute} disabled={true}>
                ...
                <Button variant="ghost" className="flex flex-col items-center justify-center h-auto px-3 py-2 disabled:opacity-50 hover:bg-transparent" disabled={true}>
                    <div className="bg-secondary rounded-full p-3">
      ...
      <div className="flex flex-col items-center justify-center text-center gap-2 w-full">
        ...
        <div className="flex justify-center items-start gap-1">
          {isCalling ? (
            ...
            >
              <div className="bg-destructive hover:bg-destructive/90 rounded-full p-3 transition-colors">
                {confirmHangup ? (
    ...
    <Card className="w-full max-w-sm shadow-2xl">
      <CardContent className="p-0">
        <div className="flex flex-col items-center justify-center p-4 gap-3">
            <div className={cn(
                "w-36 h-36 rounded-full border-4 flex flex-col items-center justify-center transition-colors duration-500",
